...
function gameInit() {
    createjs.Sound.registerSound({
        src: "./static_YL/music/err.mp3",
        id: "err"
    });
    createjs.Sound.registerSound({
        src: "./static_YL/music/end.mp3",
        id: "end"
    });
    createjs.Sound.registerSound({
        src: "./static_YL/music/tap.mp3",
        id: "tap"
    });
    gameRestart();
}
...
function gameTime() {
    _gameTimeNum--;
    if (_gameTimeNum <= 0) {
        GameTimeLayer.innerHTML = '&nbsp;&nbsp;&nbsp;&nbsp;时 间 没 有 了 ';
        gameOver();
...
function shareText(score) {
    ...
    SubmitResults();
    if (score <= 49) return '重新来过！';
    if (score <= 99) return '表扬';
...
console.log("你打开了一个一个开发工具啊啊啊啊啊啊")
